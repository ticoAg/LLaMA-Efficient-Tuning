...
#     --lora-modules sft-lora=scripts/dpo_exp/qwen1.5-0.5/sft_ckpt dpo-lora=scripts/dpo_exp/qwen1.5-0.5/dpo_ckpt \
#     --port 26926 \
...
# CUDA_VISIBLE_DEVICES=0 python -m vllm.entrypoints.openai.api_server \
#     --model scripts/dpo_exp/qwen1.5-0.5/qwen1.5-0.5B-sft \
