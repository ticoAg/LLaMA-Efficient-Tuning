...
exp_id=Baichuan2-13B-Sfted-RM-HH-RLHF
model_name_or_path=Baichuan2-13B-Base-Sfted-Mixed
dataset=hh_rlhf_harmless_cn_train,hh_rlhf_helpful_cn_train
template=baichuan2
gpu_vis=0,1,2
MASTER_PORT=2346
acclerate_config=train_scripts/acc_config/config_0_2.yaml
