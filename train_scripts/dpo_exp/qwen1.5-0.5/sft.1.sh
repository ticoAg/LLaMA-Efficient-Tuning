...
# --deepspeed train_scripts/dpo_exp/qwen1.5-14/ds_z3_config.json \
...
CUDA_VISIBLE_DEVICES=0 python src/train_bash.py \
    ...
    --output_dir .cache/Align/qwen1.5-0.5B-sft-v1-mix_7m_zh_en_8k_c64 \
    --use_fast_tokenizer \
    ...
    --bf16 \
    --report_to wandb \
    --run_name qwen1.5-0.5B-sft-v1-mix_7m_zh_en_8k_c64